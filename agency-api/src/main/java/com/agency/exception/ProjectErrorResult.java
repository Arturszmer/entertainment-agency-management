...
public enum ProjectErrorResult implements AgencyErrorResult {
    ...
    PROJECT_NOT_FOUND(HttpStatus.NOT_FOUND, "AP001", "Project with public id %s does not exist"),
    ...
    COST_NOT_FOUND(HttpStatus.NOT_FOUND, "AP005", "Cost with public id %s was not found"),
    PROJECT_COST_NOT_FOUND(HttpStatus.NOT_FOUND, "AP006", "Cost with public id %s was not found"),
    ;
